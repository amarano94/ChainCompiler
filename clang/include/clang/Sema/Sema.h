...
public:
  ...
  StmtResult ActOnTaskStmt(SourceLocation TaskLoc, Stmt *Body);
  ...
  StmtResult ActOnNextTaskStmt(SourceLocation NextTaskLoc, Expr *NextTaskExp);
  StmtResult ActOnChOutStmt(SourceLocation ChOutLoc, Expr *ChOutExp);
  ...
  ExprResult ActOnChInExpr(SourceLocation Loc, Expr * E);
  ExprResult ActOnBracketExpr(SourceLocation L, SourceLocation R, Expr * E);
