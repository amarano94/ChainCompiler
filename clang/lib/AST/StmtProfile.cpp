...
void StmtProfiler::VisitTaskStmt(const TaskStmt *S) {
   VisitStmt(S);
}
...
void StmtProfiler::VisitNextTaskStmt(const NextTaskStmt *S) {
  VisitStmt(S);
}

void StmtProfiler::VisitChOutStmt(const ChOutStmt *S) {
  VisitStmt(S);
}
...
void StmtProfiler::VisitChInExpr(const ChInExpr *S) {
  VisitExpr(S);
}

void StmtProfiler::VisitBracketExpr(const BracketExpr *S) {
  VisitExpr(S);
}
