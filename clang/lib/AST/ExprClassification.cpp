...
#include "clang/AST/StmtNodes.inc"
  ...
  case Expr::ChInExprClass:
    return ClassifyInternal(Ctx, cast<ChInExpr>(E)->getSubExpr());

  case Expr::BracketExprClass:
    return ClassifyInternal(Ctx, cast<BracketExpr>(E)->getSubExpr());
